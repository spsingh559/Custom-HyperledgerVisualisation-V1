...
app.use(function(req, res, next) {
	...
	// var orgname = "uniper" ;
		...
		invoke.invokeChaincode(peer, channelName, chaincodeName, fcn, args, req.username, req.orgname,app)
...
app.post('/channels', function(req, res) {
	...
	console.log('-------------------------------username and orgname in create channel',req.username, req.orgname);
